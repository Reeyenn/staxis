...
export const MANAGEMENT_PATTERN_COHORT_VERSION = 'management-metric-cohort.v1' as const;
...
export const MANAGEMENT_PATTERN_EVALUATOR_VERSION = 'management-pattern-evaluator.v1' as const;

 ...
 */
export const MANAGEMENT_PATTERN_ENGINE_VERSION = 'management-pattern-engine.v1' as const;
export const MANAGEMENT_PATTERN_EVIDENCE_SCHEMA_VERSION = 1 as const;
export const MANAGEMENT_PATTERN_EVIDENCE_FORMAT = 'management-pattern-evidence.v1' as const;
...
export const MANAGEMENT_PATTERN_SOURCE_QUERY_VERSION = 'management-pattern-source-snapshot.v1' as const;
...
export const SUPPLY_SPEND_CHECK_VERSION = 'completed-month-peer-baseline.v2' as const;
...
export const SUPPLY_SPEND_COHORT_POLICY = Object.freeze({
  metricId: SUPPLY_SPEND_METRIC_ID,
  policyVersion: 'supply-spend-cohort.v2',
  dimensions: [
...
/**
 * Unknown profiles can be potential matches, so they may not disappear before
 * the cohort coverage denominator is calculated. This portfolio-domain gate
 * runs before metric-specific cohort fallback.
 */
export const SUPPLY_SPEND_PROFILE_COVERAGE_POLICY = Object.freeze({
  policyVersion: 'supply-spend-profile-domain-coverage.v1',
 ...
 * scale. Safe v1 admits only the explicitly configured USD domain; INR, EUR,

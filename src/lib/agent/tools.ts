...
export interface ToolDefinition<TArgs = unknown> {
   ...
   * complaints, lost-and-found) which are NEVER section-gated. The route map is
   * only the stale floor: executeTool performs a fresh fail-closed read before
   * every section-tagged handler.
   */
  section?: AppSection;
  /**

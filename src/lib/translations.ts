...
type TranslationKey =
  ...
  | 'lndSyncingBanner' | 'lndLoadsAppearWhenSynced'
  // Engineer / compliance mobile page (staff-facing — full locale set)
  | 'engCompliance' | 'engHi' | 'engThere'
  | 'engReadingsDoneLabel' | 'engChecksOverdueLabel'
  | 'engReadingsDue' | 'engSafetyChecks' | 'engNothingAssigned' | 'engCouldntLoad'
  | 'engAnomaly' | 'engOutOfRange' | 'engLearning' | 'engDone' | 'engDue' | 'engOverdue'
  | 'engSafe' | 'engReadPrefix' | 'engCouldNotReadManual' | 'engScanFailed'
  | 'engLogged' | 'engLoggedOutOfRange' | 'engSaveReading' | 'engUnits'
  | 'engMarkedFailedAlerted' | 'engCheckedOff' | 'engAllGood' | 'engProblem' | 'engRecheck'
  | 'engLogByVoice' | 'engVoiceHint' | 'engSpeakOrType' | 'engListeningStop' | 'engSpeak'
  | 'engLog' | 'engVoiceNotCaught'
  | 'engLoggedWord' | 'engReadingWord' | 'engReadingsWord' | 'engOutOfRangeLower'
  // Guest requests
...
const translations: TranslationMaps = {
  ...
  es: {
    ...
    lndSyncingBanner: 'Algunos datos del sistema del hotel aún se están sincronizando — los conteos de cargas pueden estar incompletos.',
    lndLoadsAppearWhenSynced: 'Las cargas de hoy aparecerán cuando el sistema del hotel termine de sincronizar.',
    // Engineer / compliance mobile page
    engCompliance: 'Cumplimiento',
    engHi: 'Hola',
    engThere: 'hola',
    engReadingsDoneLabel: 'lecturas hechas',
    engChecksOverdueLabel: 'revisiones vencidas',
    engReadingsDue: 'Lecturas pendientes',
    engSafetyChecks: 'Revisiones de seguridad',
    engNothingAssigned: 'Nada asignado ahora.',
    engCouldntLoad: 'No se pudo cargar. Recarga o reabre el enlace.',
    engAnomaly: 'Anomalía',
    engOutOfRange: 'Fuera de rango',
    engLearning: 'Aprendiendo…',
    engDone: 'Hecho',
    engDue: 'Pendiente',
    engOverdue: 'Vencida',
    engSafe: 'seguro',
    engReadPrefix: 'Leído',
    engCouldNotReadManual: 'No se pudo leer — ingresa manual.',
    engScanFailed: 'Escaneo falló.',
    engLogged: 'Registrado ✓',
    engLoggedOutOfRange: 'Registrado — fuera de rango, gerente avisado',
    engSaveReading: 'Guardar lectura',
    engUnits: 'unidades',
    engMarkedFailedAlerted: 'Marcado falla — gerente avisado',
    engCheckedOff: 'Marcado ✓',
    engAllGood: 'Todo bien ✓',
    engProblem: 'Problema',
    engRecheck: 'Volver a revisar',
    engLogByVoice: 'Registrar por voz',
    engVoiceHint: 'Di p. ej. "piscina pH 7.4, cloro 3, alcalinidad 90". Luego Registrar.',
    engSpeakOrType: 'Habla o escribe lecturas…',
    engListeningStop: '● Escuchando… parar',
    engSpeak: '🎙️ Hablar',
    engLog: 'Registrar',
    engVoiceNotCaught: 'No se entendió — intenta de nuevo.',
    engLoggedWord: 'Registrado',
    engReadingWord: 'lectura',
    engReadingsWord: 'lecturas',
    engOutOfRangeLower: 'fuera de rango',
    // Guest requests
    pending: 'Pendiente',
    doneToday: 'Listo Hoy',
    assign: 'Asignar',
  ...
  ht: {
    ...
    lndSyncingBanner: 'Gen kèk done sistèm otèl la k ap toujou senkronize — kantite chaj yo ka pa konplè.',
    lndLoadsAppearWhenSynced: 'Chaj jodi a yo ap parèt lè sistèm otèl la fin senkronize.',
    // Engineer / compliance mobile page
    engCompliance: 'Konfòmite',
    engHi: 'Bonjou',
    engThere: 'zanmi',
    engReadingsDoneLabel: 'lekti ki fèt',
    engChecksOverdueLabel: 'tchèk an reta',
    engReadingsDue: 'Lekti pou fè',
    engSafetyChecks: 'Tchèk sekirite',
    engNothingAssigned: 'Pa gen anyen asiyen kounye a.',
    engCouldntLoad: 'Nou pa t ka chaje. Rafrechi oswa relouvri lyen an.',
    engAnomaly: 'Anomali',
    engOutOfRange: 'Andeyò ranje a',
    engLearning: 'Ap aprann…',
    engDone: 'Fèt',
    engDue: 'Pou fè',
    engOverdue: 'An reta',
    engSafe: 'an sekirite',
    engReadPrefix: 'Li',
    engCouldNotReadManual: 'Nou pa t ka li — antre l alamen.',
    engScanFailed: 'Eskanè a echwe.',
    engLogged: 'Anrejistre ✓',
    engLoggedOutOfRange: 'Anrejistre — andeyò ranje a, jeran an avèti',
    engSaveReading: 'Sove lekti a',
    engUnits: 'inite',
    engMarkedFailedAlerted: 'Make kòm echwe — jeran an avèti',
    engCheckedOff: 'Make ✓',
    engAllGood: 'Tout bon ✓',
    engProblem: 'Pwoblèm',
    engRecheck: 'Re-tchèke / repare sa',
    engLogByVoice: 'Anrejistre lekti ak vwa',
    engVoiceHint: 'Di pa egzanp "pisin pH 7.4, klò 3, alkalinite 90". Apre sa peze Anrejistre.',
    engSpeakOrType: 'Pale oswa tape lekti yo…',
    engListeningStop: '● Ap koute… rete',
    engSpeak: '🎙️ Pale',
    engLog: 'Anrejistre',
    engVoiceNotCaught: 'Nou pa t konprann — eseye ankò oswa tape l.',
    engLoggedWord: 'Anrejistre',
    engReadingWord: 'lekti',
    engReadingsWord: 'lekti',
    engOutOfRangeLower: 'andeyò ranje a',
  },
  ...
  tl: {
    ...
    lndSyncingBanner: 'May ilang datos ng sistema ng hotel na nagsi-sync pa — maaaring hindi kumpleto ang bilang ng mga karga.',
    lndLoadsAppearWhenSynced: 'Lalabas ang mga karga ngayong araw kapag natapos nang mag-sync ang sistema ng hotel.',
    // Engineer / compliance mobile page
    engCompliance: 'Pagsunod',
    engHi: 'Kumusta',
    engThere: 'kaibigan',
    engReadingsDoneLabel: 'tapos na basa',
    engChecksOverdueLabel: 'tseke na lampas na',
    engReadingsDue: 'Mga babasahin',
    engSafetyChecks: 'Mga pagsusuri sa kaligtasan',
    engNothingAssigned: 'Walang nakatalaga ngayon.',
    engCouldntLoad: 'Hindi ma-load. I-refresh o buksang muli ang link.',
    engAnomaly: 'Anomalya',
    engOutOfRange: 'Wala sa saklaw',
    engLearning: 'Natututo…',
    engDone: 'Tapos',
    engDue: 'Dapat gawin',
    engOverdue: 'Lampas na',
    engSafe: 'ligtas',
    engReadPrefix: 'Nabasa',
    engCouldNotReadManual: 'Hindi mabasa — ilagay nang manu-mano.',
    engScanFailed: 'Nabigo ang pag-scan.',
    engLogged: 'Naitala ✓',
    engLoggedOutOfRange: 'Naitala — wala sa saklaw, naabisuhan ang manager',
    engSaveReading: 'I-save ang babasahin',
    engUnits: 'mga yunit',
    engMarkedFailedAlerted: 'Minarkahang bigo — naabisuhan ang manager',
    engCheckedOff: 'Nasuri na ✓',
    engAllGood: 'Ayos lahat ✓',
    engProblem: 'Problema',
    engRecheck: 'Suriin muli / ayusin ito',
    engLogByVoice: 'Itala ang mga babasahin gamit ang boses',
    engVoiceHint: 'Sabihin hal. "pool pH 7.4, chlorine 3, alkalinity 90". Tapos i-Log.',
    engSpeakOrType: 'Magsalita o mag-type ng mga babasahin…',
    engListeningStop: '● Nakikinig… itigil',
    engSpeak: '🎙️ Magsalita',
    engLog: 'Itala',
    engVoiceNotCaught: 'Hindi naunawaan — subukan muli o i-type.',
    engLoggedWord: 'Naitala',
    engReadingWord: 'babasahin',
    engReadingsWord: 'mga babasahin',
    engOutOfRangeLower: 'wala sa saklaw',
  },
  ...
  vi: {
    ...
    lndSyncingBanner: 'Một số dữ liệu hệ thống khách sạn vẫn đang đồng bộ — số mẻ giặt có thể chưa đầy đủ.',
    lndLoadsAppearWhenSynced: 'Các mẻ giặt hôm nay sẽ xuất hiện khi hệ thống khách sạn đồng bộ xong.',
    // Engineer / compliance mobile page
    engCompliance: 'Tuân thủ',
    engHi: 'Chào',
    engThere: 'bạn',
    engReadingsDoneLabel: 'số đo đã xong',
    engChecksOverdueLabel: 'kiểm tra quá hạn',
    engReadingsDue: 'Số đo cần làm',
    engSafetyChecks: 'Kiểm tra an toàn',
    engNothingAssigned: 'Hiện chưa có gì được giao.',
    engCouldntLoad: 'Không tải được. Kéo để làm mới hoặc mở lại liên kết.',
    engAnomaly: 'Bất thường',
    engOutOfRange: 'Ngoài phạm vi',
    engLearning: 'Đang học…',
    engDone: 'Xong',
    engDue: 'Cần làm',
    engOverdue: 'Quá hạn',
    engSafe: 'an toàn',
    engReadPrefix: 'Đọc',
    engCouldNotReadManual: 'Không đọc được — nhập thủ công.',
    engScanFailed: 'Quét thất bại.',
    engLogged: 'Đã ghi ✓',
    engLoggedOutOfRange: 'Đã ghi — ngoài phạm vi, đã báo quản lý',
    engSaveReading: 'Lưu số đo',
    engUnits: 'đơn vị',
    engMarkedFailedAlerted: 'Đánh dấu lỗi — đã báo quản lý',
    engCheckedOff: 'Đã kiểm ✓',
    engAllGood: 'Tất cả ổn ✓',
    engProblem: 'Vấn đề',
    engRecheck: 'Kiểm lại / sửa cái này',
    engLogByVoice: 'Ghi số đo bằng giọng nói',
    engVoiceHint: 'Nói ví dụ "hồ bơi pH 7.4, clo 3, độ kiềm 90". Rồi nhấn Ghi.',
    engSpeakOrType: 'Nói hoặc gõ số đo…',
    engListeningStop: '● Đang nghe… dừng',
    engSpeak: '🎙️ Nói',
    engLog: 'Ghi',
    engVoiceNotCaught: 'Không nghe rõ — thử lại hoặc gõ vào.',
    engLoggedWord: 'Đã ghi',
    engReadingWord: 'số đo',
    engReadingsWord: 'số đo',
    engOutOfRangeLower: 'ngoài phạm vi',
  },
};

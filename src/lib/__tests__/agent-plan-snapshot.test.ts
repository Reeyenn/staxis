...
test('vision request routes forward caller cancellation into provider execution', () => {
  for (const route of [
    ...
    'src/app/api/financials/scan-invoice/route.ts',
    'src/app/api/financials/scan-quote/route.ts',
    'src/app/api/front-desk/lost-and-found/describe-photo/route.ts',
    'src/app/api/front-desk/packages/scan-label/route.ts',

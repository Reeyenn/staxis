...
const WORKER_META: Record<string, { description: string; group: WorkerGroup }> = {
  ...
  'pms-auth-codes-purge':                { description: 'Deletes expired PMS inbox messages and report files, and shreds any report that arrived with a card number on it.', group: 'Cleanup' },

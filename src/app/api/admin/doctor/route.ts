...
export const EXPECTED_CRONS: Array<{ name: string; cadenceHours: number; description: string }> = [
  ...
  { name: 'financials-alert-sweep',        cadenceHours: 24, description: 'Daily financials sweep — projects month-end overspend per department (occupancy-adjusted) + flags spend anomalies, texts the property alert phone. Idempotent/no-spam via app_events dedup; SMS billing-gated on raw pid' },
];

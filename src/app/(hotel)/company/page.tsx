...
function HotelsPanel({ data, structure, structureError, structureLoading, lang, query, onQueryChange, statusFilter, onStatusFilterChange, onStructureRetry, onStructureChanged }: {

      ...
      <div style={{
        ...
        <div style={{ position: 'relative', maxWidth: 1600, margin: '0 auto' }}>
          ...
          <div style={{
            ...
            <span style={LABEL}>{cur?.date.toLocaleDateString(locale, { month: 'short' }).toUpperCase()}</span>
            <h1 style={{
          ...
          <div style={{
            ...
            <div style={{
              ...
              <div>
                <div style={LABEL}>
                  {cur ? `${cur.date.toLocaleDateString(locale, { weekday: 'long' }).toUpperCase()} · ${cur.date.toLocaleDateString(locale, { month: 'short' }).toUpperCase()} ${cur.day}` : ''}
                </div>

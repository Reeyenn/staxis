...
const S = {
  sopsTitle: { en: 'How we do things', },
  sopsSub: {
    en: 'The written procedures for this hotel. Staxis answers from these.',

  },
  docsTitle: { en: 'Documents', },
  docsSub: {
    en: 'Files you have given Staxis to read. It searches the full text of each one.',

  },
  newSop: { en: 'Add a procedure', },
  editSop: { en: 'Edit procedure', },
  upload: { en: 'Upload a file', },
  uploading: { en: 'Uploading…', },
  newFolder: { en: 'New folder', },
  create: { en: 'Create', },
  rename: { en: 'Rename', },
  folderName: { en: 'Folder name', },
  allDocs: { en: 'All documents', },
  notInFolder: { en: 'Not in a folder', },
  noFolder: { en: 'No folder', },
  folder: { en: 'Folder', },
  whoSees: { en: 'Who can see it', },
  access: { en: 'Access & folder', },
  ...
  sopsEmptyStaff: { en: 'No procedures have been published yet.', },
  docsEmpty: { en: 'No documents yet.', },
  docsEmptyFolder: { en: 'No documents in this folder yet.', },
  sopsLoadFailed: {
  ...
  docsUnavailable: { en: 'Documents could not load.', },
  foldersUnavailable: { en: 'Folders could not load.', },
  sopDeleteFailed: { en: 'The procedure was not deleted. Try again.', },
  docDeleteFailed: { en: 'The document was not deleted. Try again.', },
  folderCreateFailed: { en: 'Could not create the folder.', },
  folderRenameFailed: { en: 'The folder was not renamed.', },
  folderDeleteFailed: { en: 'The folder was not deleted.', },
  accessFailed: { en: 'Could not update who can see it.', },
  moveFailed: { en: 'Could not move the document.', },
  saveFailed: { en: 'Could not save. Try again.', },
  confirmDeleteSop: { en: 'Delete this procedure?', },
  confirmDeleteDoc: { en: 'Delete this document?', },
  confirmDeleteFolder: {
    en: 'Delete this folder? The files inside are kept. They just move out of the folder.',

  },
  fTitle: { en: 'Title', },
  fTitlePh: { en: 'e.g. Breakfast bar setup', },
  fCategory: { en: 'Category (optional)', },
  fCategoryPh: { en: 'e.g. Front desk, Breakfast, Safety', },
  fBody: { en: 'Steps / content', },
  fBodyPh: { en: 'Write the procedure here.', },
  visAll: { en: 'All staff', },
  visManagers: { en: 'Managers only', },
  emptyBody: { en: '(No content yet.)', },
  lastUpdated: { en: 'Last updated by', },

...
export function QueueView({ lang }: { lang: 'en' | 'es' }) {
  ...
  const isHotelPerson = !drilling && canSee && companyScope === null;
  ...
  // person — so for a single-hotel account it is one probe that returns null
  // and draws nothing. One endpoint, and no way for the two screens to both be
  // on the page.
  return (
    <>

...
const S = {
  ...
  sub: {
    ...
    es: 'Proveedores, números de emergencia, representantes de marca y lugares cercanos.',
  },
  add: { en: 'Add contact', es: 'Agregar' },
  ...
  empty: {
    ...
    es: 'Aún no hay contactos. Agrega proveedores, números de emergencia, representantes de marca y lugares cercanos.',
  },
  emptyStaff: {
    en: 'No contacts have been added yet. Ask your manager to add them.',
    es: 'Aún no se han agregado contactos. Pídele a tu gerente que los agregue.',
  },
  ...
  refreshFailed: {
    ...
    es: 'No se pudo actualizar la lista de contactos. Se muestran los últimos resultados.',
  },
  retry: { en: 'Try again', es: 'Reintentar' },
  deleteFailed: { en: 'The contact was not deleted. Try again.', es: 'No se eliminó el contacto. Inténtalo de nuevo.' },
  saveFailed: { en: 'Could not save. Try again.', es: 'No se pudo guardar. Inténtalo de nuevo.' },
  confirmDelete: { en: 'Delete this contact?', es: '¿Eliminar este contacto?' },
  dismiss: { en: 'Dismiss', es: 'Cerrar' },
  newContact: { en: 'New contact', es: 'Nuevo contacto' },
  editContact: { en: 'Edit contact', es: 'Editar contacto' },
  fName: { en: 'Name', es: 'Nombre' },
  ...
  fAddressPh: { en: 'e.g. 1200 Main St', es: 'ej. 1200 Calle Principal' },
  fCity: { en: 'City, state & ZIP', es: 'Ciudad, estado y CP' },
  fCityPh: { en: 'e.g. Beaumont, TX 77701', es: 'ej. Beaumont, TX 77701' },
  fHours: { en: 'Hours', es: 'Horario' },
  fHoursPh: { en: 'e.g. Mon–Fri 8a–9p, Sat 9a–6p', es: 'ej. Lun–Vie 8a–9p, Sáb 9a–6p' },
  fNotes: { en: 'Notes (optional)', es: 'Notas (opcional)' },

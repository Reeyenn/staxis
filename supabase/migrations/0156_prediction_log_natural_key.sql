-- ═══════════════════════════════════════════════════════════════════════════
-- Staxis / HotelOps AI — prediction_log natural key + date index (Migration 0156)
--
...
values ('0156', 'Phase 7 v2: prediction_log natural unique key + (property, layer, date) index for safe UPSERT and rolling-MAE queries')

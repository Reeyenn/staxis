-- ═══════════════════════════════════════════════════════════════════════════
-- 0236 — Self-serve reports: report_favorites + report_schedules
-- ═══════════════════════════════════════════════════════════════════════════
--
...
comment on table public.report_schedules is
  ...
  'infra. Service-role only; access via /api/settings/reports/*. Created 0236.';
...
comment on policy report_favorites_deny_browser on public.report_favorites is
  ...
  'with supabaseAdmin. Created 0236.';

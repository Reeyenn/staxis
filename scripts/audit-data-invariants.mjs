...
/** pms_* tables scoped to a PMS FAMILY, not to a hotel. Verified 2026-07-24:
 *  these are the only three of 28 without property_id, and each is shared
 *  across every hotel on that family by design. */

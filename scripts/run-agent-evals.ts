...
// at production data if the env var was missing. Tools are dry-run by
// default (the runner sets RunAgentOpts.dryRun=true), but we still want
// the property choice to be explicit.
